...
namespace OmoriDialogueParser
{
    class YamlInterpreter
    {
        ...
        public static YamlInterpreter Parse(TextReader reader, Model.SystemData system)
        {
        ...
        private static PayloadList ParsePayloads(string text, Model.SystemData system)
        {
            if (text == null)
            ...
            for (var i = 0; i < text.Length; i++)
            {
                ...
                {
                    if (parsedPayload is not TextPayload)
        ...
        private static bool TryGetPayload(string text, out IPayload payload, Model.SystemData system)
        {
